...
```sql
.read queries/qb08-governance-gap/preflight.duckdb.sql    -- CHECK: can this data answer the question?
.read queries/qb08-governance-gap/diagnostic.duckdb.sql   -- LEARN: the ranked field, rules as pass/fail flags
.read queries/qb08-governance-gap/query.duckdb.sql        -- TRUST: what actually fires
```
