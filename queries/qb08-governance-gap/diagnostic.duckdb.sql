-- QB08 -- Governance Gap : DIAGNOSTIC / TEACHING view (DuckDB)
--
...
--
-- Unlike most detectors here, QB08 is a COVERAGE measure, not an anomaly: a healthy
-- estate trends toward 0% untagged. Watch the percentage, not a single row.
--
-- Run it (from the ./run.sh prompt):
--   .read queries/qb08-governance-gap/diagnostic.duckdb.sql
