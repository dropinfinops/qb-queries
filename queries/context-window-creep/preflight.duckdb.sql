-- Context Window Creep -- Context-Window Creep : PREFLIGHT / data-readiness check (DuckDB)
--
-- Run this BEFORE the detector. It answers one question: can this data even answer
-- the question Context Window Creep asks?
--
...
--   .read queries/context-window-creep/preflight.duckdb.sql
