...
```sql
.read queries/context-window-creep/preflight.duckdb.sql    -- CHECK: can this data answer the question?
.read queries/context-window-creep/diagnostic.duckdb.sql   -- LEARN: the ranked field, rules as pass/fail flags
.read queries/context-window-creep/query.duckdb.sql        -- TRUST: what actually fires
```
