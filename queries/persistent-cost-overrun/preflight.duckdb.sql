-- Persistent Cost Overrun -- Runaway Cost Acceleration : PREFLIGHT / data-readiness check (DuckDB)
--
-- Run this BEFORE the detector. It answers one question: can this data even answer
-- the question Persistent Cost Overrun asks?
--
...
--   .read queries/persistent-cost-overrun/preflight.duckdb.sql
