...
```sql
.read queries/unauthorized-compute/preflight.duckdb.sql    -- CHECK: can this data answer the question?
.read queries/unauthorized-compute/diagnostic.duckdb.sql   -- LEARN: the ranked field, rules as pass/fail flags
.read queries/unauthorized-compute/query.duckdb.sql        -- TRUST: what actually fires
```
