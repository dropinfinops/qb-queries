# QB21 — Compromised API Credential
...
- The `$50` 48-hour floor is deliberately low — a compromised API key generating $50 in
  ...
  high-value breaches.
- This pattern is complementary to QB15 (Runaway Inference): QB15 detects sustained drift
  over 3+ days on accounts with existing AI history. QB21 detects the fast-burn, zero-history
