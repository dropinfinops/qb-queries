-- QB21 -- Compromised API Credential : PREFLIGHT / data-readiness check (DuckDB)
--
-- Run this BEFORE the detector. It answers one question: can this data even answer
-- the question QB21 asks?
--
...
--   .read queries/qb21-compromised-api-credential/preflight.duckdb.sql
