-- Commitment Loss -- Commitment Loss : PREFLIGHT / data-readiness check (DuckDB)
--
-- Run this BEFORE the detector. It answers one question: can this data even answer
-- the question Commitment Loss asks?
--
...
--   .read queries/commitment-loss/preflight.duckdb.sql
