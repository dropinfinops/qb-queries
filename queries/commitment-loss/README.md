...
```sql
.read queries/commitment-loss/preflight.duckdb.sql    -- CHECK: can this data answer the question?
.read queries/commitment-loss/diagnostic.duckdb.sql   -- LEARN: the ranked field, rules as pass/fail flags
.read queries/commitment-loss/query.duckdb.sql        -- TRUST: what actually fires
```
...
- For a utilization-ratio approach using `consumedquantity / pricingquantity`, see Over-Provisioned Capacity
