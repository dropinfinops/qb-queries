-- Orphaned Resources -- Waste : PREFLIGHT / data-readiness check (DuckDB)
--
-- Run this BEFORE the detector. It answers one question: can this data even answer
-- the question Orphaned Resources asks?
--
...
--   .read queries/orphaned-resources/preflight.duckdb.sql
