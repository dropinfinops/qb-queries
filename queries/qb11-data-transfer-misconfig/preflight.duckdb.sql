-- QB11 -- Data-Transfer Misconfiguration : PREFLIGHT / data-readiness check (DuckDB)
--
-- Run this BEFORE the detector. It answers one question: can this data even answer
-- the question QB11 asks?
--
...
--   .read queries/qb11-data-transfer-misconfig/preflight.duckdb.sql
