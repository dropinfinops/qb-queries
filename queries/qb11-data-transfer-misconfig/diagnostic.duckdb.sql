-- QB11 -- Data-Transfer Misconfiguration -- per-GB legs dominating : DIAGNOSTIC / TEACHING view (DuckDB)
--
...
--   .read queries/qb11-data-transfer-misconfig/diagnostic.duckdb.sql
