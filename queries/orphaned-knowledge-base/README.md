...
```sql
.read queries/orphaned-knowledge-base/preflight.duckdb.sql    -- CHECK: can this data answer the question?
.read queries/orphaned-knowledge-base/diagnostic.duckdb.sql   -- LEARN: the ranked field, rules as pass/fail flags
.read queries/orphaned-knowledge-base/query.duckdb.sql        -- TRUST: what actually fires
```
