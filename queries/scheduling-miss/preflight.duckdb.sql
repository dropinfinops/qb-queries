-- Scheduling Miss -- Scheduling Miss : PREFLIGHT / data-readiness check (DuckDB)
--
-- Run this BEFORE the detector. It answers one question: can this data even answer
-- the question Scheduling Miss asks?
--
...
--   .read queries/scheduling-miss/preflight.duckdb.sql
