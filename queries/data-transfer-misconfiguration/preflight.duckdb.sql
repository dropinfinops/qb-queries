-- Data Transfer Misconfiguration -- Data-Transfer Misconfiguration : PREFLIGHT / data-readiness check (DuckDB)
--
-- Run this BEFORE the detector. It answers one question: can this data even answer
-- the question Data Transfer Misconfiguration asks?
--
...
--   .read queries/data-transfer-misconfiguration/preflight.duckdb.sql
