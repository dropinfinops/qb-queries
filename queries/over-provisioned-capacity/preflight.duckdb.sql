-- Over-Provisioned Capacity -- Utilization Ratio : PREFLIGHT / data-readiness check (DuckDB)
--
-- Run this BEFORE the detector. It answers one question: can this data even answer
-- the question Over-Provisioned Capacity asks?
--
...
--   .read queries/over-provisioned-capacity/preflight.duckdb.sql
