-- Runaway AI Inference -- Runaway Inference : PREFLIGHT / data-readiness check (DuckDB)
--
-- Run this BEFORE the detector. It answers one question: can this data even answer
-- the question Runaway AI Inference asks?
--
...
--   .read queries/runaway-ai-inference/preflight.duckdb.sql
