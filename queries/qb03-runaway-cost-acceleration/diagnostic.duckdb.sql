-- QB03 -- Runaway Cost Acceleration -- sustained elevation, not a blip : DIAGNOSTIC / TEACHING view (DuckDB)
--
...
--   .read queries/qb03-runaway-cost-acceleration/diagnostic.duckdb.sql
