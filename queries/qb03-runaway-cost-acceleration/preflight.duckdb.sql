-- QB03 -- Runaway Cost Acceleration : PREFLIGHT / data-readiness check (DuckDB)
--
-- Run this BEFORE the detector. It answers one question: can this data even answer
-- the question QB03 asks?
--
...
--   .read queries/qb03-runaway-cost-acceleration/preflight.duckdb.sql
